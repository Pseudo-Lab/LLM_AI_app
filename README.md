...
| -------- | -------- | ---- |
| 2025/03/04 | OT       | ALL |
| 2025/03/11 |  1.1 LLM 개념 ~ 1.2 LLM 특징과 종류 | 권선옥 | 
| 2025/03/18 |  1.3 LLM 생성 과정 ~ 1.4 LLM 생성 후 추가 고려 사항 | 홍혜선 | 
| 2025/03/25 |  🧙 1st Magical Week 🧙(오프라인 모임) | 휴일 |
| 2025/04/01 |  2.1 LLM 활용 방법 ~ 2.3 LLM의 한계 | 김효진 | 
| 2025/04/08 |  3.1 RAG 개념 ~ 3.3 RAG 구현 시 필요한 것 | 권선옥 | 
| 2025/04/15 |  4.1 랭체인 훑어보기, 4.3 랭체인 주요 모듈 <br> (✅ 4.2 랭체인을 사용하기 위한 환경 구성은 모든 구성원 수행) | 홍혜선 | 
| 2025/04/22 |  5.1 간단한 챗봇 만들기 ~ 5.2 RAG 기반의 챗봇 만들기 | 강승현 |
| 2025/04/29 |  🧙 2nd Magical Week 🧙(오프라인 모임) | 휴일 |
| 2025/05/06 |  5.3 PDF 요약 웹사이트 만들기 ~ 5.4 독립형 질문 챗봇 만들기 | 김효진 |
| 2025/05/13 |  5.5 대화형 챗봇 만들기 ~ 5.6 번역 서비스 만들기 | 공준호 | 
| 2025/05/17 |  🔮 PseudoCon 🔮(가짜연구소 컨퍼런스 행사) | - |
| 2025/05/20 |  5.7 메일 작성기 만들기 ~ 5.8 CSV 파일 분석하기(마지막) | 강승현 | 

### 프로젝트 실습을 통해 얻을 수 있는 결과물(예시)
- 총 8개의 mini-ai app을 만들 수 있습니다(+ 책 내용을 바탕으로 자신만의 ai-app도 만들 수 있습니다)
<img src="https://i.postimg.cc/zv4tXwTW/image.png" width="910">
